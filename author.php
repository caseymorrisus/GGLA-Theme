	...
	<div class="row">
		<div class="container" id="container">
			<div class="item_wrapper">
				...
				$posttypes = array('post','blog');
				$args = array( 'post_type' => $posttypes, 'posts_per_page' => 9, 'paged' => $paged );
				...
				while ( $wp_query->have_posts() ) : $wp_query->the_post(); ?>
					...
					<div class="item">
						...
						<a href="<?php the_permalink() ;?>"><?php if (get_field('article_image')) : ?><img src="<?php the_field( 'article_image' ); ?>"><?php endif; ?><?php if (function_exists('has_post_thumbnail') && has_post_thumbnail()) the_post_thumbnail(); ?></a>
