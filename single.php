<?php get_header(); ?>
	...
	<div class="page_wrapper">
		...
		<div class="row article_preview">
			<div class="container">
				<figure>
					<?php $prevPost = get_previous_post(true); $prevThumbnail = get_the_post_thumbnail($prevPost->ID); echo $nextthumbnail; ?><?php previous_post_link( '%link', $prevThumbnail ); ?>
				</figure>
				<figure>
					<?php
					$related = get_posts( array( 'category__not_in' => wp_get_post_categories($post->ID), 'numberposts' => 1, 'post__not_in' => $do_not_duplicate ) );
				...
				<figure>
					<?php $nextPost = get_next_post(true); $nextThumbnail = get_the_post_thumbnail($nextPost->ID); echo $nextthumbnail; ?><?php next_post_link( '%link', $nextThumbnail ); ?>
				</figure>
			</div>
		</div>
				...
				<div class="container">
					...
					<div class="col span_two_thirds follow">
						<div class="content_title">
							<p>
								Be up to date on eSports. Follow <a href="#">GGLA</a> now!
							</p>
							<p>

								<a href="https://www.facebook.com/GoldGamingLosAngeles"></a>
								<a href="https://twitter.com/goldgamingLA"></a>
								<a href="http://www.youtube.com/user/goldgamingla"></a>
								<a href="https://plus.google.com/105651646126170603226/posts"></a>
