	...
	<div class="row">
		<div class="container" id="container">
			<div class="item_wrapper">
				...
				<?php $page_title = wp_title('', false); $page_category = str_replace(' ', '-', $page_title); $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
				$args = array( 'post_type' => 'post', 'posts_per_page' => 10, 'paged' => $paged, 'category_name' => $page_category );
